...
export GOPATH="$CRYPTO_CONFIG_ROOT_FOLDER/$ORG_NAME/gopath"

export NODECHAINCODE="$CRYPTO_CONFIG_ROOT_FOLDER/$ORG_NAME/nodechaincode"

# export CORE_PEER_MSPCONFIGPATH=$CRYPTO_CONFIG_ROOT_FOLDER/$ORG_NAME/$PEER_NAME/ledger
# export CORE_PEER_FILESYSTEMPATH=$HOME/ledgers/$ORG_NAME/$PEER_NAME
