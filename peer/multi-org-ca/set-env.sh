...
export FABRIC_CFG_PATH="$CRYPTO_CONFIG_ROOT_FOLDER/$ORG_NAME/$PEER_NAME"
...
export CORE_PEER_FILESYSTEM_PATH="/var/ledgers/Automobile/$ORG_NAME/$PEER_NAME/ledger" 
...
export PEER_LOGS=$PWD/client/$ORG_NAME/$PEER_NAME
