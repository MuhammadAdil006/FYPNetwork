...
function registerAdmins {
   ...
   #5 registring manufacturer admin
...
function enrollAdmins {
    ...
    setupMSP
     ...
     # 3. orderer-admin
    echo "Enrolling: manufacturer-admin"
...
#     SETUP_CONFIG_CLIENT_YAML="`pwd`/ca-client-yaml"
